...
依据《本地部署大模型服务等级（SLA）》定义，5 档推理 + 2 档训练。

**推理类（5 个，均 20 路并发）：**

| ID | 名称 | 上下文 | 并发 | 开销 | 典型场景 |
|----|------|--------|------|------|----------|
| sla-1 | SLA-1 实时交互型 | 8K | 20 | 15% | 产品问答、销售话术生成、简单知识查询 |
| sla-2 | SLA-2 标准业务型 | 16K | 20 | 15% | 多轮对话、客户画像分析、CRM 记录分析 |
| sla-3 | SLA-3 深度业务型 | 32K | 20 | 15% | 客户全景分析、复杂方案生成、多资料联合问答 |
| sla-4 | SLA-4 长文档分析型 | 64K | 20 | 15% | 会议纪要、合同、销售方案及标书分析 |
| sla-5 | SLA-5 超长文档分析型 | 128K | 20 | 15% | 整份标书、合同集、长录音转写及多文档联合分析 |
